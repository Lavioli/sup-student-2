        ...
        mongoose.connection.db.dropDatabase(function() {
            bcrypt.genSalt(10, function(err, salt) {
                bcrypt.hash('password', salt, function(err, hash) {
                    User.create({username: 'admin', password: hash}) //starts each test with a user admin and a hash password
                        .then(function(user) {
                            done();
                        });
                });
        ...
        describe('GET', function() {
            it('should return a single user initially', function() {
                ...
                return chai.request(app)
                    ...
                    .auth('admin', 'password')
                    .then(function(res) {
                        // Check that it's an empty array NOT ANYMORE
    ...
    describe('/users/:userId', function() {
        ...
        describe('PUT', function() {
            it('should allow editing a user', function() {
                var oldUser = {
                    username: 'joe',
                    password: '$2a$04$pSfILtUTKjbDOztVx4ERiuiUMh84k.h.GUNTai/QgwzfydZMp9iAa' //hashed joespass
                };
            ...
            it('should create a user if they don\'t exist', function() {
                this.skip();
                //how do you authenticate a user that doesn't exist?
                var user = {
        ...
        describe('DELETE', function() {
            it('should 404 on non-existent users', function() {
                this.skip();
                //this only makes sense if admins are a thing
                var spy = makeSpy();
            ...
            it('should delete a user', function() {
                var user = {
                    username: 'joe',
                    password: '$2a$04$pSfILtUTKjbDOztVx4ERiuiUMh84k.h.GUNTai/QgwzfydZMp9iAa'
                };
                var userId;
