    ...
    beforeEach(function(done) {
        ...
        mongoose.connection.db.dropDatabase(function(err, res) {
            ...
            this.alice = {
                ...
                password: '$2a$10$JWmFu3dU4dx.ari5E7wHouRs4EAOHfQQy6fnMWj8f9Tb7FA6eD7R6'
            };

            this.bob = {
                username: 'bob',
                _id: 'bbbbbbbbbbbbbbbbbbbbbbbb',
                password: '$2a$10$3osa2iZF9dbal4NWFIrSNO3laX0M8yHlnwbl5S.cZ63rX9rkbpJ6i'
            };

            this.chuck = {
                username: 'chuck',
                _id: 'cccccccccccccccccccccccc',
                password: '$2a$10$5IaKW5a4haCiU8GRZhlGJO.tq.UUgHQa1laGk1AqZvxqiXFrsIUiG'
            };
